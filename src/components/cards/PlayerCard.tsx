...
> = {
  ...
  oro: {
    frame: "border-presi-gold/90 shadow-[0_0_16px_rgba(239,217,140,0.45)]",
    panel: "bg-presi-surface",
    stripe: "from-presi-gold/35 via-presi-maroon/15 to-transparent",
    badge: "bg-presi-gold text-presi-bg",
    label: "Oro",
    position: "text-presi-gold",
    name: "text-white",
    meta: "text-presi-ivory/80",
    price: "text-presi-gold",
  },
  leyenda: {
    frame: "border-2 border-transparent p-[2px] legend-holo shadow-[0_0_18px_rgba(239,217,140,0.4)]",
    panel: "bg-presi-bg",
    stripe: "from-presi-gold/30 via-presi-maroon/20 to-transparent",
