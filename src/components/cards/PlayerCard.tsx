...
> = {
  ...
  oro: {
    frame: "border-presi-gold/90 shadow-[0_0_16px_rgba(245,241,71,0.45)]",
    panel: "bg-presi-surface",
    stripe: "from-presi-gold/35 via-presi-coral/10 to-transparent",
    badge: "bg-presi-gold text-presi-bg",
    label: "Oro",
    position: "text-presi-gold",
    name: "text-white",
    meta: "text-presi-sand/80",
    price: "text-presi-gold",
  },
  leyenda: {
    frame: "border-2 border-transparent p-[2px] legend-holo shadow-[0_0_18px_rgba(71,245,215,0.4)]",
    panel: "bg-presi-bg",
    stripe: "from-presi-cyan/30 via-presi-violet/20 to-transparent",
