...
export function FormationPitch({
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-andes-deep/10 bg-gradient-to-b from-emerald-800/80 to-emerald-900/90 p-4">
              ...
              return (
                <div
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-full border-2 text-[10px] font-bold ${
                    filled
                      ? "border-andes-gold bg-andes-gold text-andes-deep"
